  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved society as @society" do
        ...
        post :create, {:society => { "name" => "invalid value" }}, valid_session
        assigns(:society).should be_a_new(Society)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested society" do
        ...
        Society.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => society.to_param, :society => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the society as @society" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Society.any_instance.stub(:save).and_return(false)
        put :update, {:id => society.to_param, :society => { "name" => "invalid value" }}, valid_session
        assigns(:society).should eq(society)
      end
